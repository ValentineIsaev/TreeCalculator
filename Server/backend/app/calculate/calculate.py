...
from MathTools.math_tools import wind_power, roll_angle, tree_sole_moment, separation_angle, tipping_angle
...
class CalculateManager:
    ...
    def calculate_wind_load(self,
        ...
        return wind_load(wind_speed, c_d, crown_square, tree_height)
    ...
    def calculate_max_wind_speed_break(self,
        ...
        return max_wind_break(diameter, c_d, crown_square, tree_height, max_strength)
    ...
    def calculate_roll_angle(self,
        ...
        wind_force = wind_power(wind_speed, c_d, crown_square)
        sole_moment = tree_sole_moment(a, b)

        return roll_angle(wind_force, sole_moment, c_soil_hardness, tree_weight,
    ...
    def calculate_separation_angle(self,
        ...
        return separation_angle(tree_weight, c_soil_hardness, a, b)
    ...
    def calculate_tipping_angle(self,
            ...
            return tipping_angle(tree_weight, center_gravity_height, b, c_soil_hardness)
    ...
    def calculate_max_wind_tipping(self,
        ...
        return max_wind_tipping(tree_weight, center_gravity_height, a, b, c_soil_hardness, c_d,
                                crown_square, tree_height)
    ...
    def calculate_separation_wind_speed(self,
        ...
        return separation_wind_speed(tree_weight,
                                     c_soil_parameter,
                                     a,
                                     b,
